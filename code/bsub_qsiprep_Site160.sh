...
for i in $(cat tmpsubs.txt); do
    ...
    apptainer run --containall --writable-tmpfs --nv \
        -B $HOME/elgan_dti/code:/code,$HOME/elgan_dti/data/Site-160_ELGAN:/bids,$HOME/elgan_dti/data/Site-160_ELGAN/derivatives/qsiprep:/out,$HOME/elgan_dti/work:/work,license.txt:/opt/freesurfer/license.txt \
        qsiprep-v1.0.1.sif \
